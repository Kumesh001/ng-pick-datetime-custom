...
var DateTimePickerComponent = (function () {
    function DateTimePickerComponent(renderer, ngZone, numFixedLenPipe) {
        ...
        this.disabledDates = [];
        this.placeHolder = 'yyyy/mm/dd hh:mm A';
        ...
        if (this.dataType === 'date') {
            ...
            if (this.value && this.value.length) {
                ...
                for (var _i = 0, _a = this.value; _i < _a.length; _i++) {
                    var v = _a[_i];
                    if (v) {
                        if(this.locale!=null && this.locale.dateFormat!=null && this.locale.dateFormat!=''){
                          formatted.push(date_fns_1.format(v, this.locale.dateFormat, { locale: this.locale.dateFns }));
                        }else{
              ...
              if(this.locale!=null && this.locale.dateFormat!=null && this.locale.dateFormat!=''){
                this.onModelChange(date_fns_1.format(this.value, this.locale.dateFormat, { locale: this.locale.dateFns }));
              }else{
    ...
    DateTimePickerComponent.prototype.updateFormattedValue = function () {
        ...
        if (this.value) {
            if (this.isSingleSelection()) {
              if(this.locale!=null && this.locale.dateFormat!=null && this.locale.dateFormat!=''){
                formattedValue = date_fns_1.format(this.value, this.locale.dateFormat, { locale: this.locale.dateFns });
              }else{
                ...
                if(this.locale!=null && this.locale.dateFormat!=null && this.locale.dateFormat!=''){
                  formattedValue = date_fns_1.format(startDate, this.locale.dateFormat, { locale: this.locale.dateFns });
                  if (endDate) {
                      formattedValue += ' - ' + date_fns_1.format(endDate, this.locale.dateFormat, { locale: this.locale.dateFns });
                  }
                  else {
                      formattedValue += ' - ' + this.locale.dateFormat;
                  }
                }else{
                ...
                for (var i = 0; i < this.value.length; i++) {
                    ...
                    if(this.locale!=null && this.locale.dateFormat!=null && this.locale.dateFormat!=''){
                      dateAsString = date_fns_1.format(this.value[i], this.locale.dateFormat, { locale: this.locale.dateFns });
                    }else{
                      dateAsString = date_fns_1.format(this.value[i], this.dateFormat, { locale: this.locale.dateFns });
                    }
